...
{
{text = 'اضغط هنا للدخول للصانع', url = 't.me/TYU_KA_BOT '},
},
}
...
keyboard.inline_keyboard = {
{
{text = 'ﺂﺑۆ ړُﭠۆﭴھَہّ 𖤇', url = 't.me/l_b10'},
},
{
{text = '𝑺𝑶𝑼𝑹𝑪𝑬 𝐖𝐀𝐑𝐑𝐈𝐎𝐑', url = 't.me/r5558 '},
},
}
local msgg = msg.id/2097152/0.5
...
معرف الصانع (@TYU_KA_BOT) •

اوامر بوت فازر ↑↓

- (https://t.me/r5558/1009)
...
local T =[[
 [𝐖𝐄l𝐂𝐎𝐌𝐄 𝐓𝐎 𝐒𝐎𝗨𝐑𝐂𝐄 𝐍𝐀𝐑𝐎𝐓𝐎  •](t.me/r5558 )
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
...
if text == 'ابورتوجه' or text == '• مبرمج السورس' or text == '✧ مبرمج السورس' then  
...
local TestText = "*▷ 𝑫𝑬𝑽𝑬𝑳𝑶𝑷𝑬𝑹 𝑱𝑨𝑩𝑾𝑨  🖤\n▷ 𝑵𝑨𝑴𝑬 ▹* ["..UserInfo.first_name.."](tg://user?id="..UserId_Info.id..")\n*▷ 𝑩𝑰𝑶 ▹ "..Bio.." *"
keyboardd = {} 
keyboardd.inline_keyboard = {
{
{text = username, url = "https://t.me/JABWA"}
},
}
